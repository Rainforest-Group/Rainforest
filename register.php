            ...
            <div class="modal-header"><h3>Registeration</h3></div>
                            <form method="GET" action="AccountIn">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="lastname" name="firstname" value="" required="" title="Please enter you username" placeholder="First name">
                                    <label for="username" class="control-label">Last name</label>
                                    <input type="text" class="form-control" id="lastname" name="lastname" value="" required="" title="Please enter you username" placeholder="Last name">
                                    ...
                                    <input type="password" class="form-control" id="password" name="password" value="" required="" title="Please enter your password" placeholder="Confirm password">
                                </div>
